...
export const DOC_CATEGORIES: DocCategory[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: 'stripe-dues', title: 'Set up recurring Stripe dues', summary: 'Let members subscribe so dues reconcile themselves each cycle.' },
      ...
      { slug: 'create-tasks-chores', title: 'Create tasks & recurring chores', summary: 'Add one-off and recurring work with assignments, due dates, and areas.' },
      { slug: 'track-projects', title: 'Track projects', summary: 'Run a shared board of what the space is building.' },
      { slug: 'use-comms-and-forum', title: 'Use comms & the forum', summary: 'Post to channels and threads for space-wide discussion.' },
      { slug: 'manage-ops-knowledge', title: 'Write ops docs & store secrets', summary: 'Author knowledge base entries and keep credentials in the encrypted vault.' },
