...
export async function listMemberBilling() {
  ...
  return {
    data: (data ?? []).map(r => {
      ...
      const sm = r.space_members as unknown as { display_name: string | null; email: string | null; tier: string | null } | { display_name: string | null; email: string | null; tier: string | null }[] | null
