      ...
      <div className="relative z-10 w-full max-w-[460px] mx-4">
        ...
        <div className="bg-[#1a1a1a] rounded-b px-10 py-10">
          ...
          <div className="flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 bg-[#232323] border border-[#333] text-white font-mono text-xs py-2.5 rounded hover:border-[#555] transition">
